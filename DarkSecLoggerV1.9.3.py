#!/usr/bin/env python3
# File: DarkSecLoggerV1.9.3_Refactored.py
# DarkSec Logger v1.9.3 – Smaller Minimum GUI Size
...
APP_TITLE = "DarkSec Logger v1.9.3 – Human-Only JSON Logs & IP Tools"
DEFAULT_PORT = 8000
...
class DarkSecApp:
    def __init__(self, root):
        ...
        ## PATCHED: Lowered the minimum window size for better scaling ##
